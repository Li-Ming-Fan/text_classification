# -*- coding: utf-8 -*-
"""
Created on Sat Jan 19 05:07:46 2019
...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser('debug-sentence-cls')
...
#
def do_debug(vocab, settings, data_pkl_basename):
    #
...
if __name__ == '__main__':
    ...
    #
    # run
    do_debug(vocab, settings, pkl_basename)
    #
